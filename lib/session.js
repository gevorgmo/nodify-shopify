...
(function() {
  var ApplicationCharge, Asset, Article, Blog, Checkout, Collect, Comment, Country, CustomCollection, Customer, CustomerGroup, CustomerSavedSearch, DiscountCode, Event, Fulfillment, Order, Page, PriceRule, Product, ProductImage, ProductSearchEngine, ProductVariant, Province, RecurringApplicationCharge, Redirect, Refund, ScriptTag, Session, Shop, SmartCollection, Theme, Transaction, Webhook, crypto, empty, isNumeric, sortObj, trim;
  ...
  DiscountCode = require('./resources/discount_code');
  ...
  PriceRule = require('./resources/price_rule');
  ...
  Session = (function() {
    ...
    function Session(url1, apiKey, secret, params1) {
      ...
      if (this.valid) {
		...
		this.discountCode = new DiscountCode(this.site());
		...
		this.priceRule = new PriceRule(this.site());
