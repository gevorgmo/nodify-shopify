...
(function() {
  var Blog, Order, Product, Resource, PriceRule, Session, SessionOAuth,
  ...
  SessionOAuth = (function(superClass) {
    ...
    SessionOAuth.prototype.getScope = function(scope1) {
      ...
      this.scope = scope1;
      types = ['content', 'themes', 'products', 'customers','product_listings', 'inventory', 'locations','fulfillments', 'analytics','users','checkouts','reports','marketing_events','resource_feedbacks','all_orders', 'orders', 'draft_orders','script_tags', 'shipping', 'price_rules','collection_listings'];
      scope = [];
